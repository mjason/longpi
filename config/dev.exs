...
config :longpi, Longpi.Repo,
  database: Path.expand("../longpi_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :longpi, dev_routes: true, token_signing_secret: "4YkjM7FAljkJS5oBbrls3wJ5WidqPSRv"
...
# Local-only secrets (LLM gateway key etc.) - gitignored, optional.
