...
#
#     PHX_SERVER=true bin/longpi start
#
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/longpi/longpi.db
      """
  ...
  config :longpi, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
