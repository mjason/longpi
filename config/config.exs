...
config :esbuild,
  ...
  longpi: [
    args:
      ~w(js/index.tsx js/app.js --bundle --target=es2022 --outdir=../priv/static/assets --external:/fonts/* --external:/images/* --loader:.woff=file --loader:.woff2=file --loader:.ttf=file --alias:@=./js --splitting --format=esm),
...
# The websocket bearer token rides the connect params; keep it out of logs.
