...
export type ConversationResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "title" | "cwd" | "model" | "systemPrompt" | "reasoningEffort" | "agentRole" | "turnStartedAt" | "unseenAt" | "unseenKind" | "insertedAt" | "updatedAt" | "parentId";
  id: UUID;
  title: string | null;
  cwd: string;
  model: string;
  ...
  unseenAt: UtcDateTimeUsec | null;
  unseenKind: string | null;
  insertedAt: UtcDateTimeUsec;
  updatedAt: UtcDateTimeUsec;
  parentId: UUID | null;
  parent: { __type: "Relationship"; __resource: ConversationResourceSchema | null; };
};
...
export type ModelResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "spec" | "label" | "enabled" | "position" | "contextWindow" | "insertedAt" | "updatedAt";
  id: UUID;
  spec: string;
  label: string | null;
  enabled: boolean;
...
export type ConversationFilterInput = {
  ...
  parent?: ConversationFilterInput;
...
export const conversationFilterFields = ["id", "title", "cwd", "model", "systemPrompt", "reasoningEffort", "agentRole", "turnStartedAt", "unseenAt", "unseenKind", "insertedAt", "updatedAt", "parentId", "parent"] as const;
...
export const conversationSortFields = ["id", "title", "cwd", "model", "systemPrompt", "reasoningEffort", "agentRole", "turnStartedAt", "unseenAt", "unseenKind", "insertedAt", "updatedAt", "parentId"] as const;
