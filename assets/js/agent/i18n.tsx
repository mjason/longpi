...
const en = {
  ...
  "msg.retry": "Retry",
  "retry.countdown": "Gateway hiccup — retrying automatically in {seconds}s (attempt {attempt}/{max}). Progress is saved.",
  "resume.notice": "The last run was interrupted; saved progress is intact.",
  "resume.action": "Resume",
  "loop.running": "Loop running · {done}/{total}",
  "loop.cancel": "Cancel",

  // Workspace sidebar (file tree + git panel)
  "ws.files": "Files",
  "ws.git": "Git",
  "ws.refresh": "Refresh",
  "ws.showHidden": "Show hidden files",
  "ws.hidden": "{count} hidden",
  "ws.empty": "Nothing here yet.",
  "ws.emptyDir": "Empty directory",
  "ws.notARepo": "Not a git repository",
  "ws.clean": "Working tree clean",
  "ws.changes": "Changes",
  "ws.staged": "Staged",
  "ws.stage": "Stage",
  "ws.unstage": "Unstage",
  "ws.stageAll": "Stage all",
  "ws.unstageAll": "Unstage all",
  "ws.discard": "Discard changes",
  "ws.discardConfirm": "Discard changes to {file}? This cannot be undone.",
  "ws.commitPlaceholder": "Commit message…",
  "ws.commit": "Commit · {count}",
  "ws.amend": "Amend last commit",
  "ws.history": "History",
  "ws.diffTruncated": "Diff truncated.",
  "ws.binaryDiff": "Binary file — no diff.",
  "unseen.approval": "A tool is waiting for your approval (auto-denies after 5 minutes)",
  "unseen.failed": "A run failed while you were away",
  "unseen.done": "New activity finished while you were away",
  "msg.more": "More",
  "msg.edit": "Edit",
  "msg.cancel": "Cancel",
  "msg.update": "Update",
...
const zh: Record<I18nKey, string> = {
  ...
  "msg.regenerate": "重新生成",
  "msg.retry": "重试",
  "retry.countdown": "网关故障 — {seconds} 秒后自动重试(第 {attempt}/{max} 次),已完成的进度已保存。",
  "resume.notice": "上次运行被打断,已完成的进度已保存。",
  "resume.action": "继续",
  "loop.running": "循环运行中 · {done}/{total}",
  "loop.cancel": "取消",
  ...
  "ws.git": "Git",
  "ws.refresh": "刷新",
  "ws.showHidden": "显示隐藏文件",
  "ws.hidden": "{count} 个隐藏",
  "ws.empty": "这里还没有内容。",
  "ws.emptyDir": "空目录",
  "ws.notARepo": "不是 git 仓库",
  "ws.clean": "工作区干净",
  "ws.changes": "变更",
  "ws.staged": "已暂存",
  "ws.stage": "暂存",
  "ws.unstage": "取消暂存",
  "ws.stageAll": "全部暂存",
  "ws.unstageAll": "全部取消暂存",
  "ws.discard": "丢弃改动",
  "ws.discardConfirm": "丢弃 {file} 的改动?此操作不可撤销。",
  "ws.commitPlaceholder": "提交信息…",
  "ws.commit": "提交 · {count}",
  "ws.amend": "修补上次提交",
  "ws.history": "历史",
  "ws.diffTruncated": "diff 已截断。",
  "ws.binaryDiff": "二进制文件——无 diff。",
  "unseen.approval": "有工具在等你审批(5 分钟后自动拒绝)",
  "unseen.failed": "有任务在你离开时失败了",
  "unseen.done": "有任务在你离开时完成了",
  "msg.more": "更多",
  "msg.edit": "编辑",
  "msg.cancel": "取消",
  "msg.update": "更新",
